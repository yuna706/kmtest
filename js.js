    ...
    $("#q5").click(function(){
        ...
        switch(j){
            case 0:
                ...
                ex.append('<br><img src="img/ma1.png" alt="마케팅 경영과 사진1"><br> <img src="img/ma2.png" alt="마케팅 경영과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020200&master=html&act=page">마케팅경영과 더 알아보기</a>');
                console.log(j);
                break;
            case 1:
                depar.text("베이커리 카페과");
                ...
                ex.append('<br><img src="img/ba1.png" alt="베이커리 카페과 사진1"> <br><img src="img/ba2.png" alt="베이커리 카페과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020500&master=html&act=page">베이커리카페과 더 알아보기</a>');
                break;
            case 2:
                depar.text("패션산업 디자인과");
                ex.append('<h3>패션디자인과 시각지다인에 열정이 있고 흥미가 있는 학생이라면, 교육과정을 통해 패션 관련 전문가로 꿈을 펼칠 수 있는 기회가 주어집니다.</h3><br>');
                ex.append('<p>의상을 기획하고 스케치하는 과정을 통해 제품을 제작하여 브랜딩화 합니다. 교육과정 이수 후에는 패션 관련 학과 진학 및 패션 관련 기업 취업을 목표로 하고 있습니다.</p>');
                ex.append('<br><img src="img/fa1.png" alt="패션산업 디자인과 사진1"><br> <img src="img/fa2.png" alt="패션산업 디자인과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020300&master=html&act=page">패션산업디자인과 더 알아보기</a>');
                break;
            case 3:
                depar.text("앱 서비스과");
                ex.append('<h3>앱서비스과에서는 입학과 동시에 학생의 진로희망을 토대로 맞춤형 교육을 실시하고 있습니다.</h3><br>');
                ...
                ex.append('<br><img src="img/app1.png" alt="앱 서비스과 사진1"><br> <img src="img/app2.png" alt="앱 서비스과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020400&master=html&act=page">앱서비스과 더 알아보기</a>');
                break;
        }
    })
})