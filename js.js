$(function(){
    ...
    switch(j){
        case 0:
            ...
            ex.append('<br><img src="img/ma1.png" alt="마케팅 경영과 사진1"> <img src="img/ma2.png" alt="마케팅 경영과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020200&master=html&act=page">마케팅경영과 더 알아보기</a>');
            break;
        case 1:
            depar.text("베이커리 카페과");
            ...
            ex.append('<br><img src="img/ba1.png" alt="베이커리 카페과 사진1"> <img src="img/ba2.png" alt="베이커리 카페과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020500&master=html&act=page">베이커리카페과 더 알아보기</a>');
            break;
        case 2:
                ...
                ex.append('<br><img src="img/fa1.png" alt="패션산업 디자인과 사진1"> <img src="img/fa2.png" alt="패션산업 디자인과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020300&master=html&act=page">패션산업디자인과 더 알아보기</a>');
                break;
        case 3:
            depar.text("앱 서비스과");
            ...
            ex.append('<br><img src="img/app1.png" alt="앱 서비스과 사진1"> <img src="img/app2.png" alt="앱 서비스과 사진2"> <br> <a href="http://www.kmh.hs.kr/main.php?menugrp=020400&master=html&act=page">앱서비스과 더 알아보기</a>');
            break;
    }
})